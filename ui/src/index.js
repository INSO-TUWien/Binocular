...
import projectIssue from './visualizations/project-issue';

const visualizationModules = [dashboard, codeOwnershipRiver, issueImpact, hotspotDials, codeHotspots, languageModuleRiver, projectIssue];
