...
export default () =>
  <div className={cx('box', styles.help)}>
    ...
    <ul>
      ...
      <li>
        When "Changes" is selected, commits are graphed according to the relative amount of changes (i.e., number of lines changed) by each
        author. The total height of the commit graph is still measured by the absolute commit count however, in order to keep consistent
