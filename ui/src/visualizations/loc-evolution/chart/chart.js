...
export default class locEvolution extends React.Component {
  ...
  render() {
    ...
    // ******* Try mit import * from prototyp
    // return(
    //   <div id="fuckmylife">{myprototyp}</div>
    // )
    // ******* Try mit HTML ******
    // return(
    ...
    // return (
    //   <div id="myDataviz">
    //     <ScriptTag isHydrating={true} src="../../../../assets/prototyp.js" />
    //   </div>
    // );
    /* ****** Try mit myFunc als Funktion, oder so ********
    return (
      <this.myfunc/>
    );*/
    /*
