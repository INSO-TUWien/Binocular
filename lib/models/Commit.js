       ...
       */
        ...
        switch (changeType) {
          ...
          case 2:
            ...
            parentLineCount = parentContent.split('\n').length;
          ...
          default:
            ...
            if (parentContent.split('\n').length < 1000) {
              ...
              for (let i = 0; i < biggerChunkCount; i++) {
                ...
                changes = changes.concat(myers.diff(parentContentChunk, currentContentChunk, { compare: 'lines' }));
              }
            }
            break;
        }
