 ...
 * @returns {Promise<*>}
 */
async function importer(componentType, components, provider, repo, reporter, clean) {
  ...
  provider.context = await GenericImporter(repo, componentType, components, reporter);
  return provider.context;
}
