                ...
                .then((existingMergeRequest) => {
                  if (
                    ...
                    if (!existingMergeRequest) {
                      return MergeRequest.persist(mergeRequest).then(() => persistMergeRequestCount++);
                    } else {
                      _.assign(existingMergeRequest, mergeRequest);
                      return existingMergeRequest.save({ ignoreUnknownAttributes: true }).then(() => persistMergeRequestCount++);
                    }
                  } else {
