    ...
    return Branch.rawDb.query(
      aql`
            ...
            LET persistedBranches = (FOR branch IN branches
              ...
              LET persistedBranch = (FOR b in ${Branch.collection} FILTER b.branchKey == branch.branchKey LIMIT 1 RETURN b)[0]
                ...
                UPDATE { 
                  headShas: append( /* append the headShas element with the potential new headSha */
                    remove_value( /* remove the headShas element of the indexing project */
                      ...
                      (persistedBranch.headShas[* filter CURRENT.project == branch.headShas[0].project limit 1])[0]
                    ), 
                    branch.headShas[0]
                  ) 
                } 
