...
module.exports = function (req, res) {
  ...
  return (
    ...
    gitUtils
      ...
      .then((repo) => {
        baseRepository = repo;
        return gitUtils.cleanRepoAndCheckOutBranch(rebaseRepoPath, rebaseBranch);
      })
      // create a remote if necessary
      .then(() =>
        gitUtils.createRemoteAndFetch(
          baseRepository,
          rebaseRepo,
          upstreamRepo,
          upstreamBranch,
      ...
      // save the potentially updated upstreamRepo and upstreamBranch based on the potentially set remote
      .then((upstreamBranch) => {
