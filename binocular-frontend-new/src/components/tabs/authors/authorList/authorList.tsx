  ...
  return (
    <div
      ...
      <div>
        {dragging && (
          <div
            className={authorListStyles.authorDropNoParent}
            onDrop={(event) => {
      ...
      <div>
        {authors
          ...
          .map((parentAuthor, i) => {
            return (
              <div key={'author' + i}>
                <div className={authorListStyles.authorContainer}>
                  <input
                    type={'checkbox'}
                ...
                {authors
                  ...
                  .map((author, i) => {
                    return (
                      <div key={'author' + i} className={authorListStyles.authorContainer}>
